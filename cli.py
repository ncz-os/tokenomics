...
def cmd_ingest(args) -> int:
    ...
    if args.host == "goose":
        ...
        from adapters.hermes import iter_sessions  # noqa: built next
        pairs = iter_sessions(args.source)
    else:
...
def main(argv=None) -> int:
    ...
    ing.add_argument("--source", help="hermes saved-sessions dir (default ~/.hermes/sessions/saved)")
